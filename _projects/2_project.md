...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img src="{{ '/assets/img/field.gif' | relative_url }}"
             class="img-fluid rounded z-depth-1"
             alt="Coastal wetland fieldwork">
    </div>
</div>
